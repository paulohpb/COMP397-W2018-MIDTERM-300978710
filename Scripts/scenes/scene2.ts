module scenes {
    export class Scene2 extends objects.Scene {
      ...
      private _ocean: objects.OceanForSecondScene;
      ...
      public Start(): void {
        this._ocean = new objects.OceanForSecondScene();
      ...
      public Update(): void {
        ...
        if(this._scoreBoard.Score == 500) {
          ...
          managers.Game.currentScene = config.Scene.SCENE2;
        }
